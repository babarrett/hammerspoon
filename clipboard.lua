--[[
This code taken from: https://github.com/VFS/.hammerspoon/tree/master/tools
...
Instructions:
    ...
    The menu includes (##) indicating the number of saved clipboard items
        The menu drops down and shows the clips that have been saved
    Clicking on any item will make it the next item to be pasted
    If you open the menu while pressing option/alt, you will enter the Direct Paste Mode. 
      This means that the selected item will be "typed" instead of copied to the active 
      clipboard. (Style-free pasting)
    Clear All really does clear everything, including the current paste item. (Leaving the
      clipbord itself empty too.
    CAUTION: Copies passwords can remain on the clip.
...
local frequency = 1.2 -- Speed in seconds to check for clipboard changes. If you check too frequently, you will loose performance, if you check sparsely you will loose copies
...
--  TODO: when pasteOnSelect == true have Alt key invert the meaning
